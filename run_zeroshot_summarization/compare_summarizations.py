...
# Define file info
file_info = {'./data/annotations/gemini_annotations.csv': 'gemini',
             './data/annotations/gpt_annotations.csv': 'gpt',
             './data/annotations/claude_annotations.csv': 'claude',
             './data/annotations/nlp_annotations.csv': 'nlp'}
dfs = []
